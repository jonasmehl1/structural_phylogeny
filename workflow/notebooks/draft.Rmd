...
# seed_fa <- Biostrings::readAAStringSet("results/data/fastas/UP000005640.fa")
...
```{r read_trees}
glue("results/phylogeny/", params_dataset$phylo_dataset,"/trees/", params_dataset$seed, "_unrooted_trees.txt")
...
glue("results/phylogeny/", params_dataset$phylo_dataset,"/trees/", params_dataset$seed, "_mltrees.txt")
df_ml <- read_delim("results/old/test/trees/UP000005640_mltrees.txt", 
                    delim = "\t", 
                    show_col_types=FALSE) %>% 
...
glue("results/phylogeny/", params_dataset$phylo_dataset, "/reco/disco")

disco_fls <- list.files("results/old/test/reco/disco/", pattern = "output.nwk", full.names = T)
...
reco <- read_delim("results/old/test/reco/UP000005640_notung.tsv", 
...
apro_files <- list.files("results/old/test/reco/", 
...
df_red <- select(df_filt, query, target, singleton) 
